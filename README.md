# [💻 LiveTerm - build terminal styled websites in minutes!](https://minhtri2710.vercel.app)
...
- [personal website](https://minhtri2710.vercel.app)
...
<p align="center">
<img src="./public/minhtri2710.png" width="600"><br>
<strong><a href="https://minhtri2710.vercel.app" target=_blank>my personal website</a></strong>
</p>
...
```bash
sh -c "$(curl -fsSL https://raw.github.com/minhtri2710/LiveTerm/main/install/install.sh)"
```
...
```bash
git clone https://github.com/minhtri2710/LiveTerm.git && cd LiveTerm
```
